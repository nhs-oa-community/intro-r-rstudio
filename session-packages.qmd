...
23,482 packages (March 2026), free and structurally peer reviewed.

### GitHub

Many useful packages in development or subject to a lot of change are not on CRAN and are available through GitHub including [{NHSRtheme}](https://github.com/nhs-oa-community/NHSRtheme). These won't be peer reviewed.
